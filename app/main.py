...
from app.services.gemini_service import gemini_service, GeminiServiceException
...
async def gemini_service_exception_handler(request: Request, exc: GeminiServiceException):
    return JSONResponse(
...
@app.post(
    ...
    responses={
        ...
        500: {"description": "Internal server or API configuration error", "model": ErrorResponse},
        502: {"description": "Gemini upstream communication error", "model": ErrorResponse},
    },
...
async def extract_tournament_poster(
    poster: UploadFile = File(
        ...,
        description="Poster image file in JPEG, JPG, PNG, or WEBP format."
    )
):
    """
